# see examples at https://www.r-graph-gallery.com/315-hide-first-level-in-circle-packing.html
...
vv <- igraph::as_data_frame(g, what="vertices")
ee <- igraph::as_data_frame(g, what="edges")
